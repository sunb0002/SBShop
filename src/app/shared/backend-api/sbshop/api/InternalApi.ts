...
export class InternalApi {
     ...
     */
    public testUsingGET(extraHttpRequestParams?: any): Observable<models.HomeResponse> {
        return this.testUsingGETWithHttpInfo(extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * Get unsuccessful message
     */
    public testUsingGETWithHttpInfo(extraHttpRequestParams?: any): Observable<Response> {
